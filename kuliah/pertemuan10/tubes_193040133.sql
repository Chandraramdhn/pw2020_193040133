...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2020 at 07:19 AM
...
CREATE TABLE `buku` (
  ...
  `deskripsi buku` varchar(200) NOT NULL,
...
INSERT INTO `buku` (`ID`, `foto`, `judul buku`, `deskripsi buku`, `pengarang`, `penerbit`, `harga`) VALUES
...
(10, 'buku1.jpg', 'Di Kedalaman Samudera Al-Fatihah', 'Kita benar-benar akrab dengan al-Fatihah. Jika kita termasuk orang yang komitmen dengan shalat, maka surah yang satu ini adalah bacaan kita saat Allah memanggil kita untuk sujud. Tapi sudahkah kita ak', 'Syekh Sayyid Muhammad Syatha', 'Mirqat', 20300);
